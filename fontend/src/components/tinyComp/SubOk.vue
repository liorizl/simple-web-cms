...
.subOk{width:400px;
        ...
        border-radius: 10px;
        .subOk-c{
            width:80%;margin:10px auto 30px auto;
            .subMesRow{
                ...
                .wrongColor{color:@wrongColor;}
                .sub-icon.lright:before{content:"\e611";color:@rightColor;}
                .sub-icon.wrong:before{content:"\e616";color:@wrongColor;}
                .sub-con{margin-left:15px;font-size:16px;}
                }
            }
            .subMes{width:100%;text-align: center;height:24px;line-height:24px;}
            .twoBtn{width:80%;margin:20px auto;display: flex;justify-content: space-around;align-items: center;}
