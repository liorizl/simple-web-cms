...
.inputDiv{
    width:74%;margin:20px auto;color:#555;display:flex;align-items:center;
    .inputText{border-radius: 5px;border:1px solid #ccc;height:22px;}
    .inputTitle{width:50px;display: block;}
    input{margin-left:10px;text-indent: .5em;}
    }
.cookie{line-height:24px;text-align:left;width:76%;margin:0 auto;color:#555;}
.loginBtn{
    width:200px;height:40px;background-color: rgb(74, 152, 194);cursor:pointer;border:0;
